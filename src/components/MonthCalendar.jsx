...
// circle. Pure display: which days have money moving, at a glance.
export default function MonthCalendar({ year, month, incomeDays, expenseDays, today }) {
    ...
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)', gap: 2 }}>
        {cells.map((d, i) => {
          ...
          return (
            <div key={i} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 3, padding: '4px 0' }}>
              <div
                style={{
                  width: 26,
                  height: 26,
